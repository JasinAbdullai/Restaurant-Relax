...
$foods=@$link->query("SELECT * FROM food_details")
...
<?php
    ...
    $flag_0 = 0;
    $items=@$link->query("SELECT * FROM cart_details WHERE member_id='$memberId' AND flag='$flag_0'")
...
<div id="page">
  ...
  <li><a href="specialdeals.php">OrderOnline</a></li>
