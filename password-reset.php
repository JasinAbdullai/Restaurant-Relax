...
<?php
    if(isset($_POST['Submit'])){
        ...
        $result=@$link->query("SELECT * FROM members WHERE login='$email'")
...
<?php
    if(isset($_POST['Change'])){
        ...
        if(trim($_SESSION['member_id']) != ''){
         ...
         // update the entry
         $result = @$link->query("UPDATE members SET passwd='".md5($_POST['new_password'])."' WHERE member_id='$member_id' AND answer='".md5($_POST['answer'])."'")
         or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours. \n");  
...
<div id="reset">
  ...
  <?php
    if(isset($_POST['Submit'])){
        ...
        $question=@$link->query("SELECT * FROM questions WHERE question_id='$question_id'")
        or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours.");
