...
$result=@$link->query("SELECT * FROM food_details,categories WHERE food_details.food_category=categories.category_id ")
...
<?php
    if(isset($_POST['Submit'])){
        ...
        $result=@$link->query("SELECT * FROM food_details,categories WHERE food_category='$id' AND food_details.food_category=categories.category_id ")
        or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours."); 
    }
?>
...
<div id="header">
  ...
  <div id="company_name">RelaxRestaurant</div>
</div>
