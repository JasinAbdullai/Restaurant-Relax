    ...
    if(isset($_POST['quantity']) && isset($_POST['item']))
        {
            ...
            $qry_select=@$link->query("SELECT * FROM quantities WHERE quantity_id='$quantity_id'")
            ...
            $result=@$link->query("SELECT * FROM food_details,cart_details WHERE cart_details.member_id='$member_id' AND cart_details.flag='$flag_0' AND cart_details.food_id=food_details.food_id AND cart_details.cart_id='$cart_id'") or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours."); 
